...
#extracted 80p quantile value for each f 3 lead days (realtime)
...
def plot_last_3_days_bar(pred_series_list):
    ...
    legend_labels = [
        ...
        ("Rather Heavy Rain (35.6-64.4 mm)", "#FFFF00"),
        ("Heavy (64.5-115.5 mm)", "#FFA500"),
        ("Very Heavy (115.5-204.4 mm)", "#FF0000"),
        ("Extremely Heavy (>=204.5 mm)", "#8B0000"),
    ]
    handles = [plt.Rectangle((0, 0), 1, 1, color=color, linewidth=1, edgecolor="black")
